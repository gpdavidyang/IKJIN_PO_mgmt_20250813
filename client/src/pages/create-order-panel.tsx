...
function ImageUploadDialog({ onImageUpload }: { onImageUpload: (file: File) => void }) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>형상 이미지 업로드</DialogTitle>
        </DialogHeader>
...
export default function CreatePanelOrder() {
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 leading-tight">판넬 발주서 미리보기</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="border-green-200">
            <CardHeader className="bg-green-50">
              <CardTitle className="text-green-700 text-sm">판넬 공정</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <div className="space-y-2">
                <div>
                  <Label className="text-xs text-gray-600">납품희망일</Label>
                  <p className="text-sm font-medium">{savedData.projectSettings.panel.deliveryDate}</p>
                </div>
                <div>
                  <Label className="text-xs text-gray-600">거래처</Label>
                  <p className="text-sm font-medium">{savedData.projectSettings.panel.supplier}</p>
                </div>
                <div>
                  <Label className="text-xs text-gray-600">납품처</Label>
                  <p className="text-sm font-medium">{savedData.projectSettings.panel.deliveryLocation}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-200">
            <CardHeader className="bg-blue-50">
              <CardTitle className="text-blue-700 text-sm">조립 공정</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <div className="space-y-2">
                <div>
                  <Label className="text-xs text-gray-600">납품희망일</Label>
                  <p className="text-sm font-medium">{savedData.projectSettings.assembly.deliveryDate}</p>
                </div>
                <div>
                  <Label className="text-xs text-gray-600">거래처</Label>
                  <p className="text-sm font-medium">{savedData.projectSettings.assembly.supplier}</p>
                </div>
                <div>
                  <Label className="text-xs text-gray-600">납품처</Label>
                  <p className="text-sm font-medium">{savedData.projectSettings.assembly.deliveryLocation}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            <CardHeader className="bg-purple-50">
              <CardTitle className="text-purple-700 text-sm">설치 공정</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <div className="space-y-2">
                <div>
                  <Label className="text-xs text-gray-600">납품희망일</Label>
                  <p className="text-sm font-medium">{savedData.projectSettings.installation.deliveryDate}</p>
                </div>
                <div>
                  <Label className="text-xs text-gray-600">거래처</Label>
                  <p className="text-sm font-medium">{savedData.projectSettings.installation.supplier}</p>
                </div>
                <div>
                  <Label className="text-xs text-gray-600">납품처</Label>
                  <p className="text-sm font-medium">{savedData.projectSettings.installation.deliveryLocation}</p>
                </div>
              </div>
            </CardContent>
          </Card>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900 leading-tight">판넬 발주서</h1>
          <p className="text-sm text-gray-600">판넬 공정 전용 발주서를 작성하고 관리합니다.</p>
        </div>
      ...
      <Card className="hover:shadow-md transition-shadow border-green-200">
        <CardContent className="p-4">
          <div className="flex items-center gap-2 mb-4">
            <Layers className="h-5 w-5 text-green-600" />
            <h2 className="text-lg font-semibold text-gray-900">판넬 공정</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
                ...
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className={`h-10 w-full justify-start text-left font-normal ${
                      projectSettings.panel.deliveryDate ? "border-green-500 bg-green-50" : ""
                    }`}
                  >
                    <CalendarDays className="mr-2 h-4 w-4" />
                    {projectSettings.panel.deliveryDate || "날짜 선택"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    mode="single"
                    selected={projectSettings.panel.deliveryDate ? new Date(projectSettings.panel.deliveryDate) : undefined}
                    onSelect={(date) =>
                      setProjectSettings((prev) => ({
                        ...prev,
                        panel: { ...prev.panel, deliveryDate: date?.toISOString().split("T")[0] || "" },
                      }))
                    }
                    initialFocus
                  />
            ...
            <div className="space-y-2">
              ...
              <Select
                value={projectSettings.panel.supplier}
                onValueChange={(value) => setProjectSettings((prev) => ({ ...prev, panel: { ...prev.panel, supplier: value } }))}
              >
                <SelectTrigger className={`h-10 ${projectSettings.panel.supplier ? "border-green-500 bg-green-50" : ""}`}>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Select
                  value={projectSettings.panel.deliveryLocation}
                  onValueChange={(value) => setProjectSettings((prev) => ({ ...prev, panel: { ...prev.panel, deliveryLocation: value } }))}
                >
                  <SelectTrigger className={`h-10 ${projectSettings.panel.deliveryLocation ? "border-green-500 bg-green-50" : ""}`}>
                        ...
                        onKeyDown={(e) => {
                          if (e.key === "Enter") {
                            ...
                            if (value) {
                              ...
                              setProjectSettings((prev) => ({ ...prev, panel: { ...prev.panel, deliveryLocation: value } }))
                              e.currentTarget.value = ""
                            }
                          }
                        }}
      ...
      <Card className="hover:shadow-md transition-shadow border-blue-200">
        <CardContent className="p-4">
          <div className="flex items-center gap-2 mb-4">
            <Settings className="h-5 w-5 text-blue-600" />
            <h2 className="text-lg font-semibold text-gray-900">조립 공정</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">납품희망일</Label>
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className={`h-10 w-full justify-start text-left font-normal ${
                      projectSettings.assembly.deliveryDate ? "border-blue-500 bg-blue-50" : ""
                    }`}
                  >
                    <CalendarDays className="mr-2 h-4 w-4" />
                    {projectSettings.assembly.deliveryDate || "날짜 선택"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    mode="single"
                    selected={projectSettings.assembly.deliveryDate ? new Date(projectSettings.assembly.deliveryDate) : undefined}
                    onSelect={(date) =>
                      setProjectSettings((prev) => ({
                        ...prev,
                        assembly: { ...prev.assembly, deliveryDate: date?.toISOString().split("T")[0] || "" },
                      }))
                    }
                    initialFocus
                  />
            ...
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">거래처</Label>
              <Select
                value={projectSettings.assembly.supplier}
                onValueChange={(value) => setProjectSettings((prev) => ({ ...prev, assembly: { ...prev.assembly, supplier: value } }))}
              >
                <SelectTrigger className={`h-10 ${projectSettings.assembly.supplier ? "border-blue-500 bg-blue-50" : ""}`}>
                  <SelectValue placeholder="거래처 선택" />
                </SelectTrigger>
                <SelectContent>
                  {suppliers.map((supplier) => (
            ...
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">납품처</Label>
              <Select
                value={projectSettings.assembly.deliveryLocation}
                onValueChange={(value) => setProjectSettings((prev) => ({ ...prev, assembly: { ...prev.assembly, deliveryLocation: value } }))}
              >
                <SelectTrigger className={`h-10 ${projectSettings.assembly.deliveryLocation ? "border-blue-500 bg-blue-50" : ""}`}>
                  <SelectValue placeholder="납품처 선택" />
                </SelectTrigger>
                <SelectContent>
                  {deliveryLocations.map((location) => (
      ...
      <Card className="hover:shadow-md transition-shadow border-purple-200">
        <CardContent className="p-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-gray-900">설치 공정</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">납품희망일</Label>
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    className={`h-10 w-full justify-start text-left font-normal ${
                      projectSettings.installation.deliveryDate ? "border-purple-500 bg-purple-50" : ""
                    }`}
                  >
                    <CalendarDays className="mr-2 h-4 w-4" />
                    {projectSettings.installation.deliveryDate || "날짜 선택"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
                    mode="single"
                    selected={projectSettings.installation.deliveryDate ? new Date(projectSettings.installation.deliveryDate) : undefined}
                    onSelect={(date) =>
                      setProjectSettings((prev) => ({
                        ...prev,
                        installation: { ...prev.installation, deliveryDate: date?.toISOString().split("T")[0] || "" },
                      }))
                    }
                    initialFocus
                  />
            ...
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">거래처</Label>
              <Select
                value={projectSettings.installation.supplier}
                onValueChange={(value) => setProjectSettings((prev) => ({ ...prev, installation: { ...prev.installation, supplier: value } }))}
              >
                <SelectTrigger className={`h-10 ${projectSettings.installation.supplier ? "border-purple-500 bg-purple-50" : ""}`}>
                  <SelectValue placeholder="거래처 선택" />
                </SelectTrigger>
                <SelectContent>
                  {suppliers.map((supplier) => (
            ...
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-700">납품처</Label>
              <Select
                value={projectSettings.installation.deliveryLocation}
                onValueChange={(value) => setProjectSettings((prev) => ({ ...prev, installation: { ...prev.installation, deliveryLocation: value } }))}
              >
                <SelectTrigger className={`h-10 ${projectSettings.installation.deliveryLocation ? "border-purple-500 bg-purple-50" : ""}`}>
                  <SelectValue placeholder="납품처 선택" />
                </SelectTrigger>
                <SelectContent>
                  {deliveryLocations.map((location) => (
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-3 py-2 text-left font-medium text-gray-700">형상</th>
                  </tr>
                </thead>
                <tbody>
