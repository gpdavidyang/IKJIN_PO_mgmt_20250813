...
export default function TemplateManagement() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Filter Section */}
      <div className={`rounded-lg p-4 mb-6 shadow-sm transition-colors bg-white border-gray-200 border`}>
        <div className="flex items-center justify-between">
          <div className="flex-1 max-w-md">
            <Input
              ...
              className={`h-10 transition-colors bg-white`}
            />
          </div>
          
          <div className="flex items-center gap-6">
            {/* Statistics */}
            <div className={`flex items-center gap-4 text-sm transition-colors bg-white`}>
            ...
            <div className={`flex items-center rounded-lg p-1 transition-colors bg-white`}>
              <Button
      ...
      {viewMode === 'card' ? (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {isLoading ? (
            Array.from({ length: 6 }).map((_, index) => (
              <Card key={index} className={`animate-pulse shadow-sm transition-colors bg-white border-gray-200`}>
                <CardContent className="p-4">
                  <div className={`h-4 rounded w-3/4 mb-2 bg-white`}></div>
                  <div className={`h-3 rounded w-1/2 mb-3 bg-white`}></div>
                  <div className={`h-2 rounded w-full mb-2 bg-white`}></div>
                  <div className={`h-2 rounded w-2/3 bg-white`}></div>
                </CardContent>
              </Card>
            ))
            ...
            filteredTemplates.map((template: Template) => (
              <Card key={template.id} className={`p-4 hover:shadow-md transition-shadow shadow-sm bg-white border-gray-200`}>
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 mb-3">
                    <div className={`flex items-center text-sm gap-2 transition-colors bg-white`}>
                    ...
                    <div className={`flex items-center text-sm gap-2 transition-colors bg-white`}>
                      ...
                      {template.templateType === 'handsontable' && template.fieldsConfig?.handsontable ? (
                        ...
                        <span className={`transition-colors bg-white`}>
                          기본 템플릿
                        </span>
                      )}
                    </div>
                  ...
                  <div className={`flex items-center justify-between pt-3 border-t transition-colors bg-white`}>
                    <div className="flex items-center -space-x-1">
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent className={`transition-colors bg-white border-gray-200`}>
                          <AlertDialogHeader>
                            <AlertDialogTitle className={`transition-colors bg-white`}>템플릿 삭제</AlertDialogTitle>
                            <AlertDialogDescription className={`transition-colors bg-white`}>
                    ...
                    <div className="flex items-center gap-2">
                      <span className={`text-sm transition-colors bg-white`}>
        ...
        <div className={`rounded-lg overflow-hidden shadow-sm transition-colors bg-white border-gray-200 border`}>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className={`transition-colors bg-white`}>
                <tr className={`border-b transition-colors bg-white`}>
                  <th className={`text-left py-3 px-4 text-sm font-medium transition-colors bg-white`}>타입</th>
                  <th className={`text-left py-3 px-4 text-sm font-medium transition-colors bg-white`}>템플릿명</th>
                  <th className={`text-left py-3 px-4 text-sm font-medium transition-colors bg-white`}>생성일</th>
                  <th className={`text-left py-3 px-4 text-sm font-medium transition-colors bg-white`}>수정일</th>
                  <th className={`text-left py-3 px-4 text-sm font-medium transition-colors bg-white`}>구성</th>
                  <th className={`text-left py-3 px-4 text-sm font-medium transition-colors bg-white`}>상태</th>
                  <th className={`text-left py-3 px-4 text-sm font-medium transition-colors bg-white`}>액션</th>
                </tr>
              </thead>
                <tbody className={`divide-y transition-colors bg-white`}>
                  {isLoading ? (
                    Array.from({ length: 6 }).map((_, index) => (
                      <tr key={index} className="animate-pulse">
                        <td className="py-2 px-4">
                          <div className={`h-4 rounded w-16 bg-white`}></div>
                        </td>
                        <td className="py-2 px-4">
                          <div className={`h-4 rounded w-32 bg-white`}></div>
                        </td>
                        <td className="py-2 px-4">
                          <div className={`h-4 rounded w-20 bg-white`}></div>
                        </td>
                        <td className="py-2 px-4">
                          <div className={`h-4 rounded w-20 bg-white`}></div>
                        </td>
                        ...
                        <td className="py-2 px-4">
                          <div className={`h-4 rounded w-12 bg-white`}></div>
                        </td>
                        <td className="py-2 px-4">
                          <div className={`h-4 rounded w-20 bg-white`}></div>
                        </td>
                    ...
                    filteredTemplates.map((template: Template) => (
                      <tr key={template.id} className={`transition-colors bg-white`}>
                        <td className="py-2 px-4">
                          <Badge 
                            variant="secondary" 
                        ...
                        <td className={`py-2 px-4 text-sm transition-colors bg-white`}>
                        ...
                        <td className="py-2 px-4 text-sm">
                          {template.templateType === 'handsontable' && template.fieldsConfig?.handsontable ? (
                            ...
                            <span className={`transition-colors bg-white`}>기본</span>
                          )}
                        </td>
                        <td className="py-2 px-4">
                          <div className="flex items-center gap-2">
