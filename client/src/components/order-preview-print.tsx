        ...
        <tr>
            ...
            <table style={{ width: '100%', border: '1px solid #666', borderCollapse: 'collapse' }}>
              ...
              <tr>
                <td style={{ border: '1px solid #666', padding: '8px', fontSize: '10px' }}>
                  <div><strong>회사명:</strong> {order.company?.companyName || '(주)익진엔지니어링'}</div>
                  <div><strong>담당자:</strong> {order.user?.name || order.createdBy || '시스템'}</div>
                  <div><strong>이메일:</strong> {order.user?.email || '-'}</div>
                  <div><strong>연락처:</strong> {order.user?.phone || '-'}</div>
          ...
          <td style={{ width: '50%', verticalAlign: 'top', paddingLeft: '10px' }}>
            <table style={{ width: '100%', border: '1px solid #666', borderCollapse: 'collapse' }}>
              ...
              <tr>
                <td style={{ border: '1px solid #666', padding: '8px', fontSize: '10px' }}>
                  <div><strong>회사명:</strong> {order.vendor?.name || "거래처명"}</div>
                  <div><strong>사업자:</strong> {order.vendor?.businessNumber || "-"}</div>
                  <div><strong>담당자:</strong> {order.vendor?.contactPerson || '-'}</div>
                  <div><strong>연락처:</strong> {order.vendor?.phone || '-'}</div>
